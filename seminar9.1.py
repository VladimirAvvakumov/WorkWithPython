# Задача №2. Решение в группах 1. Проверить есть ли в файле пустые значения 
...
print(data[data['median_income']< 2]['median_house_value']) #первая переменная это искомые данные из второй переменной(массива данных)
