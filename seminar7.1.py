...
# орбиты самой далекой планеты. Каждая орбита представляет из себя кортеж из пары чисел - 
...
# print(max(orbits, key = orbits.count))
# lst = [1, 3 ,3 ,3 ,5]
def find_orbit(orbits):
    return max([orbit for orbit in orbits if orbit[0] != orbit[1]], key = lambda orbit: 3.14 * orbit[1])
